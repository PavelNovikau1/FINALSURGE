...
public class AccountSteps extends AbstractSteps {
    ...
    public void userEnteredValidEmailAndPassword() {
        loginPage.fillingEmailField(System.getenv().getOrDefault("email", System.getProperty("email",PropertyReader.getProperty("email"))))
                .fillingPasswordField(System.getenv().getOrDefault("password", System.getProperty("password",PropertyReader.getProperty("password"))));
    }
